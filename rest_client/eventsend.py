...
class es:
    ...
    async def create_global_command(self, *handlers: Callable, name: str, description: str, options: Optional[list] = None, cmd_type: int = 1) -> Any:
        ...
        return await self.rest_client.create_global_command(*handlers, application_id=self.application_id, name=name, description=description, options=options, cmd_type=cmd_type)
    ...
    async def create_guild_command(self, *handlers: Callable, guild_id: str, name: str, description: str, options: Optional[list] = None, cmd_type: int = 1) -> Any:
        ...
        return await self.rest_client.create_guild_command(*handlers, application_id=self.application_id, guild_id=guild_id, name=name, description=description, options=options, cmd_type=cmd_type)
    ...
    async def respond_message(self, content: Optional[str] = None, embed: Optional[list] = None, components: Optional[list] = None, ephemeral: bool = False) -> Any:
        ...
        return await self.rest_client.send_interaction_callback(self.interaction_id, self.interaction_token, InteractionTypes.RESPOND_WITH_MESSAGE, content, embed, components, ephemeral)
    ...
    async def send_interaction_callback(self, cmd_type: int, content: Optional[str] = None, embed: Optional[list] = None, components: Optional[list] = None, ephemeral: bool = False) -> Any:
        ...
        return await self.rest_client.send_interaction_callback(self.interaction_id, self.interaction_token, cmd_type, content, embed, components, ephemeral)
    ...
    async def send_interaction_followup(self, content: Optional[str] = None, embed: Optional[list] = None, components: Optional[list] = None, ephemeral: bool = False) -> Any:
        ...
        return await self.rest_client.send_interaction_followup(self.application_id, self.interaction_token, content, embed, components, ephemeral)
    ...
    async def get_original_interaction_message(self):
        ...
        return await self.rest_client.get_original_interaction_message(self.application_id, self.interaction_token)
    ...
    async def update_interaction_message(self, content: Optional[str] = None, embed: Optional[list] = None, components: Optional[list] = None, message_id: Optional[str] = None) -> Any:
        ...
        return await self.rest_client.update_interaction_message(self.application_id, self.interaction_token, content, embed, components, message_id)